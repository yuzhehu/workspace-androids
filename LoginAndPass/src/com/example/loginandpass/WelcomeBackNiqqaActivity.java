...
public class WelcomeBackNiqqaActivity extends Activity {
	...
	private final String TAG = WelcomeBackNiqqaActivity.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//sending result false back to MainActivity
		setBombAnswer(false);
		...
		boomNiqqa.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				/***************************************************************/
				//sending result true back to MainActivity
				Log.i(TAG, "statement reached");
				setBombAnswer(true);
			}
		});
	}
	
	//changing the result to be passed back, parameter is boolean that is to be passed back
	private void setBombAnswer(boolean clickedBoom)
	{
		Intent data = new Intent();
		data.putExtra(BOOMED_ACCESS_NAME, clickedBoom);
